...
if(rnd==3){q3=questionBank[questionNumber][1];q1=questionBank[questionNumber][2];q2=questionBank[questionNumber][3];}
 ...
 $('.pix').click(function(){
  ...
  //correct answer
  if(this.id==rnd){
   $(stage).append('<div class="feedback1">Certo</div>');
   score++;
   }
  //wrong answer	
  if(this.id!=rnd){
  ...
  setTimeout(function(){changeQuestion()},1000);
	...
	function displayFinalSlide(){
		...
		$(stage).append('<div class="questionText">Você terminou o QUIZ!<br><br>Total questões: '+numberOfQuestions+'<br>Respostas Certas: '+score+'</div>');
